...
Using D3 techniques, create a scatter plot that represents each state with circle elements. The scatter plot should ultimately appear like the image at the top of this section.
